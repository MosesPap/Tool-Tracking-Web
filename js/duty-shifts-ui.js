        ...
        // - UI event handlers (handleDragStart, handleDragEnter, handleDrop, etc.)
        // - Group management UI (renderGroups, createPersonItem, etc.)
        // - Statistics updates (updateStatistics)
        // - People search UI (filterPeopleSearch, showPeopleSearchDropdown, etc.)
        // - Rankings UI (openRankingsModal, handleRankingDragStart, etc.)
        // - Holiday management UI (renderHolidays, renderSpecialHolidays, etc.)
        // - Transfer UI (openTransferPositionModal, renderTransferAutoPreview, etc.)
        //
        // REMOVE from this file:
        // - Global variable declarations (except UI state like draggedElement, etc.)
        // - Data loading/saving (loadData, saveData)
        // - Calculation logic (calculateDutiesForSelectedMonths, run*Logic functions)
