                        ...
                        if (expectedPerson && !isPersonMissingOnDate(expectedPerson, groupNum, dayDate)) {
                            ...
                            // Check for conflicts based on day type (only if not already handled as cross-month swap)
                                ...
                                if (dayTypeCategory === 'special') {
                                    ...
                                    // Weekend skip logic is handled in runWeekendSkipLogic() after pressing Next in Step 2
                                    // No skip logic here - just check for consecutive duty conflicts
                            ...
                            // If expected person has NO conflicts, assign them
                                ...
                                // Weekend skip logic is handled in runWeekendSkipLogic() after pressing Next in Step 2
                                // No skip logic here for weekends
                                ...
                                if (!assignedPerson) {
                                    ...
                                    for (let offset = 1; offset < rotationDays && !foundReplacement; offset++) {
                                        ...
                                        if (dayTypeCategory === 'weekend') {
                                            // Weekend skip logic is handled in runWeekendSkipLogic() after pressing Next in Step 2
                                            // No skip logic here - just continue to next candidate
                                        } else if (dayTypeCategory === 'semi') {
