                    ...
                    days.forEach((dayKey, dayIndex) => {
                        ...
                        if (expectedPerson && !isPersonMissingOnDate(expectedPerson, groupNum, dayDate)) {
                            ...
                            // If expected person has NO conflicts, assign them
                                ...
                                // Normal day swap logic is handled in runNormalSwapLogic() after pressing Next in Step 4
                                // No swap logic here for normal days - just mark as skipped and find replacement
                                // (Swap logic removed - only exists in preview simulation)
                        ...
                        // Note: For normal days, swap logic is handled in runNormalSwapLogic() after pressing Next in Step 4
                        // (Swap logic removed - only exists in preview simulation)
                    });
        }
