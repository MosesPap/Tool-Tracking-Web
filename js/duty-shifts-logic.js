        ...
        // - All calculation logic (calculateDutiesForSelectedMonths)
        // - Rotation algorithms (getRotationPosition, etc.)
        // - Swap logic (runSemiNormalSwapLogic, runNormalSwapLogic, runWeekendSkipLogic)
        // - Missing/disabled person handling (findNextEligiblePersonAfterMissing, isPersonMissingOnDate, etc.)
        // - Step-by-step calculation functions (renderStep1_SpecialHolidays, renderStep2_Weekends, etc.)
        // - Assignment processing (executeCalculation, storeAssignmentReason, etc.)
        // - Conflict detection (hasConsecutiveDuty, hasConsecutiveWeekendHolidayDuty, etc.)
        //
        // REMOVE from this file:
        // - Global variable declarations (keep only calculationSteps, intendedAssignments)
        // - Data loading/saving (loadData, saveData)
        // - Excel generation (showExcelPreview, generateExcelFilesForCurrentMonth)
        // - UI rendering (renderCalendar, renderGroups, showDayDetails, etc.)
        // - Event handlers (handleDragStart, handleDrop, etc.)
        // ============================================================================
